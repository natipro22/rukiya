            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive p-0">
                        <?= form_open(base_url("departments/assign-courses/{$department}")) ?>
                        <table id="example" class="table table-condensed align-items-center justify-content-center mb-0 p-xl-0" style="width:100%">
                            ...
                            <tbody>
                                <?php foreach ($courses as $course): 
                                    ...
                                    echo '<tr>';
                                    echo '<td></td>';
                                    echo '<td class="align-middle text-sm"><input type="checkbox" name="selector[]" id="selector[]" value="'.esc($course->SUBJ_CODE). 
                    ...
                    <div class="py-4">
                    <div class="btn-group">
                        <a class="btn btn-instagram btn-sm text-capitalize" href="<?= site_url('/departments/courses/'.esc($department, 'url')) ?>">
                            <span class="fas fa-angle-double-left mx-1"> </span> Back</a>
                        <button type="submit" name="major" value="major" class="btn btn-instagram btn-sm text-capitalize " ><span class="fa fa-plus-circle mx-1"> </span> Add Major</button>
                        <button type="submit" name="minor" class="btn btn-instagram btn-sm text-capitalize " ><span class="fa fa-plus-circle mx-1"> </span> Add Minor</button>
                    </div>
                        </div>
                </div>
            </div>
