...
<div class="row mt-4">
    <div class="col-12">
        <div class="card mb-5">
            ...
            <div class="card-body">
                <?= form_open(site_url('/courses/add-course')) ?>
                <div class="px-lg-2">
                    <div class="row form-group">
                        ...
                        <div class="col-md-7 col-sm-4 col-lg-6">
                            <div class="mt-lg-2">
                                <input class="form-control" id="name" type="text" name="subj_code" value="<?= old('subj_code') ?>" placeholder="Course Name"/>
                ...
                <div class="px-lg-2">
                    <div class="row form-group">
                        ...
                        <div class="col-md-7 col-sm-4 col-lg-6">
                            <div class="mt-lg-2">
                                <input class="form-control" id="desc" type="text" name="subj_desc" value="<?= old('subj_desc') ?>" placeholder="Course Description"/>
                ...
                <div class="px-lg-2">
                    <div class="row form-group">
                        ...
                        <div class="col-md-7 col-sm-4 col-lg-6">
                            <div class="mt-lg-2">
                                <input class="form-control" id="unit" type="number"  name="subj_unit" value="<?= old('subj_unit') ?>" placeholder="Credit Hour"/>
                ...
                <div class="px-lg-2">
                    <div class="row form-group">
                        ...
                        <div class="col-md-7 col-sm-4 col-lg-6">
                            <div class="mt-lg-2">
                                <input class="form-control" id="cthr" type="number"  name="subj_cthr" value="<?= old('subj_cthr') ?>" placeholder="Contact Hour"/>
                ...
                <div class="px-lg-2">
                    <div class="row form-group">
                        ...
                        <div class="col-md-7 col-sm-4 col-lg-6">
                            <div class="mt-lg-2">
                                <input class="form-control" id="lab" type="number"  name="subj_lab" value="<?= old('subj_lab') ?>" placeholder="Lab Hour"/>
                            ...
                            <div class="mt-lg-2">
                                <select class="form-select" id="pre" name="subj_pre">
                                    ...
                                    foreach ($courses as $course):
                                        echo old('subj_pre') == $course->SUBJ_CODE ? '<option value="'.esc($course->SUBJ_CODE,'attr').'" selected>'.esc($course->SUBJ_DESCRIPTION).'</option>' 
