        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Instructor</p>
                    ...
                    <div class="col-lg-5">
                        <div class="bg-gradient-primary border-radius-lg h-100">
                            ...
                            <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                <img class="w-100 position-relative z-index-2 pt-4" src="<?= isset($profile) ? esc($profile) : site_url('public/assets/img/administrator_male.png') ?>" alt="rocket">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
